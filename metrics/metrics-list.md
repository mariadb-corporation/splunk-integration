# MariaDB Cloud Observability API - Metrics Reference
...
#### 1.1 `mariadb_global_status_aborted_clients`
...
#### 1.2 `mariadb_global_status_aborted_connects`
...
#### 1.3 `mariadb_global_status_threads_cached`
...
#### 1.4 `mariadb_global_status_threads_connected`
...
#### 1.5 `mariadb_global_status_threads_created`
...
#### 1.6 `mariadb_global_status_threads_running`
...
#### 2.1 `mariadb_global_status_bytes_received`
...
#### 2.2 `mariadb_global_status_bytes_sent`
...
#### 3.1 `mariadb_global_status_commands_total`
...
#### 3.2 `mariadb_global_status_handlers_total`
...
#### 3.3 `mariadb_global_status_queries`
...
#### 3.4 `mariadb_global_status_questions`
...
#### 3.5 `mariadb_global_status_slow_queries`
...
### 4. Data Access Metrics

Track row-level operations and data retrieval patterns.

#### 4.1 `mariadb_global_status_rows_read`
...
#### 4.2 `mariadb_global_status_rows_sent`
...
#### 5.2 `mariadb_global_status_select_full_range_join`
...
#### 5.3 `mariadb_global_status_select_range`
...
#### 5.4 `mariadb_global_status_select_range_check`
...
#### 5.5 `mariadb_global_status_select_scan`
...
### 6. Sort Operation Metrics

Monitor sorting operations and temporary table usage.

#### 6.1 `mariadb_global_status_sort_merge_passes`
...
#### 6.2 `mariadb_global_status_sort_range`
...
#### 6.3 `mariadb_global_status_sort_rows`
...
#### 6.4 `mariadb_global_status_sort_scan`
...
### 7. InnoDB Storage Engine Metrics

Monitor InnoDB buffer pool and data operations.

#### 7.1 `mariadb_global_status_buffer_pool_pages`
...
#### 7.2 `mariadb_global_status_innodb_data_read`
...
#### 7.3 `mariadb_global_status_innodb_data_written`
...
#### 7.4 `mariadb_global_status_innodb_num_open_files`
...
#### 7.5 `mariadb_global_status_innodb_page_size`
...
### 8. Table and File Metrics

Monitor table cache performance and file operations.

#### 8.1 `mariadb_global_status_open_files`
...
#### 8.2 `mariadb_global_status_open_table_definitions`
...
#### 8.3 `mariadb_global_status_open_tables`
...
#### 8.4 `mariadb_global_status_opened_files`
...
#### 8.5 `mariadb_global_status_opened_table_definitions`
...
#### 8.6 `mariadb_global_status_opened_tables`
...
#### 8.7 `mariadb_global_status_table_locks_immediate`
...
#### 8.8 `mariadb_global_status_table_locks_waited`
...
#### 8.9 `mariadb_global_status_table_open_cache_hits`
...
#### 8.10 `mariadb_global_status_table_open_cache_misses`
...
#### 8.11 `mariadb_global_status_table_open_cache_overflows`
...
#### 9.1 `mariadb_global_status_slave_running`
...
#### 10.1 `mariadb_global_status_uptime`
...
#### 11.1 `mariadb_global_variables_gtid_current_pos`
...
#### 11.2 `mariadb_global_variables_innodb_buffer_pool_size`
...
#### 11.3 `mariadb_global_variables_innodb_log_buffer_size`
...
#### 11.4 `mariadb_global_variables_key_buffer_size`
...
#### 11.5 `mariadb_global_variables_max_connections`
...
#### 11.6 `mariadb_global_variables_open_files_limit`
...
#### 11.7 `mariadb_global_variables_query_cache_size`
...
#### 11.8 `mariadb_global_variables_read_only`
...
#### 11.9 `mariadb_global_variables_table_open_cache`
...
#### 12.1 `mariadb_security_users_without_passwords`
...
### 13. CPU Resource Metrics

Monitor CPU utilization and processing time.

#### 13.1 `mariadb_server_cpu`
...
#### 13.2 `mariadb_server_cpu_system_seconds_total`
...
#### 13.3 `mariadb_server_cpu_user_seconds_total`
...
#### 13.4 `mariadb_server_spec_cpu_period`
...
### 14. Memory Resource Metrics

Track memory allocation and usage patterns.

#### 14.1 `mariadb_server_memory_cache`
...
#### 14.2 `mariadb_server_memory_rss`
...
#### 14.3 `mariadb_server_resident_memory_bytes`
...
#### 14.4 `mariadb_server_virtual_memory_bytes`
...
#### 14.5 `mariadb_server_spec_memory_limit_bytes`
...
### 15. Filesystem I/O Metrics

Monitor disk read and write operations.

#### 15.1 `mariadb_server_fs_reads_total`
...
#### 15.2 `mariadb_server_fs_reads_bytes_total`
...
#### 15.3 `mariadb_server_fs_writes_total`
...
#### 15.4 `mariadb_server_fs_writes_bytes_total`
...
### 16. Network I/O Metrics

Monitor network traffic and errors at the container level.

#### 16.1 `mariadb_server_network_receive_bytes_total`
...
#### 16.2 `mariadb_server_network_receive_errors_total`
...
#### 16.3 `mariadb_server_network_receive_packets_dropped_total`
...
#### 16.4 `mariadb_server_network_transmit_bytes_total`
...
#### 16.5 `mariadb_server_network_transmit_errors_total`
...
#### 16.6 `mariadb_server_network_transmit_packets_dropped_total`
...
### 17. Storage Volume Metrics

Monitor persistent storage capacity and utilization.

#### 17.1 `mariadb_server_volume_stats_available_bytes`
...
#### 17.2 `mariadb_server_volume_stats_capacity_bytes`
...
#### 17.3 `mariadb_server_volume_stats_used_bytes`
...
### 18. Service Health Metrics

Monitor overall service and server health status.

#### 18.1 `mariadb_service_server_network_status`
...
#### 18.2 `mariadb_service_server_status`
...
#### 20.1 `maxscale_server_connections`
...
#### 20.2 `maxscale_service_connections`
...
#### 21.2 `maxscale_threads_current_descriptors`
...
#### 21.4 `maxscale_threads_event_queue_length`
...
#### 21.6 `maxscale_threads_max_queue_time`
...
#### 21.8 `maxscale_threads_stack_size`
...
#### 21.9 `maxscale_threads_total_descriptors`
...
For additional assistance with the Observability API or metric interpretation, please contact MariaDB Cloud Support or refer to the [MariaDB Cloud Documentation](https://mariadb.com/docs/skysql/).
